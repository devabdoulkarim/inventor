...
<body id="page-top">
    <div id="app">
        <div id="wrapper">
            <!-- Sidebar -->
            <nav id="sidebar"
                v-show="$route.path === '/login' || $route.path === '/' || $route.path === '/register' || $route.path === '/forget' ? false : true " style="display:none">
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                <div id="content">
                    ...
                    <nav class="navbar navbar-expand navbar-light bg-navbar topbar mb-4 static-top" id="topbar"
                        style="display: none" v-show="$route.path === '/login' || $route.path === '/' || $route.path === '/register' || $route.path === '/forget' ? false : true ">
